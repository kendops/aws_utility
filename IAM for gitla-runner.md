...
> 🔐** ** **Note** : Always scope permissions narrowly for production environments.

---

### ✅** ****2. Create IAM Role for GitLab Runner**

You can do this using the AWS CLI or console. Here’s the AWS CLI way:
...
If using** ** **OIDC from GitLab** , your trust policy would be different—based on GitLab’s JWT token and your OIDC provider.
...
### ✅** ****4. Assign Role to the GitLab Runner Instance**
...
### ✅** ****5. (Optional) OIDC Setup (for GitLab SaaS or external runners)**

If your runner is not on EC2, configure AWS IAM OIDC federation using GitLab’s OIDC provider:
